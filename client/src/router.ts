...
export type AppRoute = "/" | "/overview" | "/login" | "/register" | "/dashboard" | "/student" | "/admin" | "/admin/audit" | "/settings" | "/alerts" | "/disputes";

const VALID_STATIC_ROUTES: AppRoute[] = ["/", "/overview", "/login", "/register", "/dashboard", "/student", "/admin", "/admin/audit", "/settings", "/alerts", "/disputes"];
