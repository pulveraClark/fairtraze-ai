...
export type AppRoute = "/" | "/overview" | "/login" | "/register" | "/forgot-password" | "/reset-password" | "/dashboard" | "/student" | "/admin" | "/admin/audit" | "/settings" | "/alerts" | "/disputes" | "/join";

const VALID_STATIC_ROUTES: AppRoute[] = ["/", "/overview", "/login", "/register", "/forgot-password", "/reset-password", "/dashboard", "/student", "/admin", "/admin/audit", "/settings", "/alerts", "/disputes", "/join"];
