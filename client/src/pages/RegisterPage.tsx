    ...
    >
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1.5">Create your account</p>
        </div>
        ...
        <div className="bg-white/[0.04] border border-white/10 rounded-2xl px-8 py-8 space-y-5">
          ...
          <div>
            ...
            <select
              disabled
              className="w-full rounded-lg bg-white/5 border border-white/10 px-3.5 py-2.5 text-sm text-slate-600 cursor-not-allowed outline-none appearance-none"
            >
          ...
          <div className="flex items-start gap-2.5 rounded-lg bg-amber-400/8 border border-amber-400/20 px-3.5 py-3">
            ...
            <p className="text-xs text-amber-300 leading-relaxed">
              Account registration is coming soon. Use{" "}
              <button
